...
[newslog](https://newslog.me) bundles your newsletters, RSS feeds, and articles into a single daily digest, complete with an index, AI-powered summaries, and calm reading modes for both Kindle and Obsidian.
...
- **Personalized Email & RSS Support**: Use your `@newslog.me` address for newsletters or add RSS feeds directly, keeping all your subscriptions out of your main inbox.
- **Daily Digest**: Receive a daily bundle of your newsletters, RSS items, and articles from the previous day. It includes an AI-generated summary to help you decide what to read in-depth.
...
- **Download daily newslog Bundle**: Opens a calendar picker to select a date. Downloads the complete daily bundle of newsletters, RSS feeds, and articles for that date in Markdown format.
...
I created newslog because I couldn't find a good way to manage my newsletters and RSS feeds:
...
- I receive a single daily bundle each morning with all of the previous day's content from my emails and RSS subscriptions.
